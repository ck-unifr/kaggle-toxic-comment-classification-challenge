...
# https://www.kaggle.com/rohitanil/lemmatization-and-pooled-gru
...
def get_model():
    ...
    x = Bidirectional(GRU(80, return_sequences=True, activation='relu', dropout=0.2, recurrent_dropout=0.2))(x)
...
submission.to_csv('submission-pooled-gru-v4.csv', index=False)
print('saved submission to submission-pooled-gru-v4.csv')
