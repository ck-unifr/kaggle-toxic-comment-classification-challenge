...
from keras.layers import Conv1D, LSTM, Bidirectional, GlobalAveragePooling1D, GlobalMaxPooling1D, Dropout
...
def get_model():
    ...
    output = Dense(len(classes), activation="sigmoid")(conc)
...
submission.to_csv('submission-cnn-lstm-v2.csv', index=False)

print('save submission to submission-cnn-lstm-v2.csv')