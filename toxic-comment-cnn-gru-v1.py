...
import codecs
from keras.layers import GRU, Dropout, Dense, Input, GlobalMaxPooling1D
...
model = get_model()
model.fit(data_train, y_train, 32, epochs=3, validation_data=(data_test, y_test))
...
sample_submission.to_csv('submission_cnn_gru_v1.csv', index=False)