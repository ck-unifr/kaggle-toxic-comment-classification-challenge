...
gru = pd.read_csv('submission-pooled-gru-fasttext.csv') # PL score 0.9829
lstm_nb_svm = pd.read_csv('submission-minimal-lstm-nb-svm-baseline-ensemble.csv') # 0.9811
lr = pd.read_csv('submission-logistic-regression-with-words-and-char-n-grams.csv') # 0.9788
lgb = pd.read_csv('submission-lightgbm-with-select-k-best-on-tfidf.csv') # 0.9785
...
submission.to_csv('submission-blend1-v3.csv', index=False)